...
rem **************************************************************************
if not exist "%~dp0\overrideEnvironment.WPF.bat" goto :noOverrideEnvironment
call "%~dp0\overrideEnvironment.WPF.bat"
...
call "%VRGIS_SETENVIRONMENT%\setEnvironment.WPF.bat" %*
...
:error
echo Error running VrGIS setEnvironment.WPF.bat
exit /b 42
