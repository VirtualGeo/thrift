...
IF %CURRENT_COMPILER% == WPF32VC14 GOTO :w32vc14

IF %CURRENT_COMPILER% == Win64VC14 GOTO :w64vc14
IF %CURRENT_COMPILER% == WPF64VC14 GOTO :w64vc14

IF %CURRENT_COMPILER% == Win32VC15 GOTO :w32vc15
IF %CURRENT_COMPILER% == Win64VC15 GOTO :w64vc15

IF %CURRENT_COMPILER% == Win32VC141 GOTO :w32vc15
IF %CURRENT_COMPILER% == Win64VC141 GOTO :w64vc15
